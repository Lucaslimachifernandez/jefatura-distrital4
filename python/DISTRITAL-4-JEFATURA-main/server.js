...
if (process.env.DATABASE_URL) {
  // Usar DATABASE_URL directamente (como en Render)
  ...
  // Configuración manual con variables de entorno (para desarrollo local)
  sequelize = new Sequelize(
    process.env.DB_NAME || 'distrital4',
...
async function connectDB() {
  try {
    ...
    logger.error('No se pudo conectar a la base de datos PostgreSQL', { error: error.message });
    throw error;
  }
}
